...
app.use(cors({
  origin: ['https://formulario-pd-net.vercel.app', 'https://domiciliar-cliente.vercel.app', 'http://localhost:4200', 'https://emailown-production.up.railway.app',"http://elpoderdeinternet.mx:8045"],
...
async function enviarCorreoPrueba(
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: process.env.GMAIL,
      pass: process.env.PASSWORD_GMAIL // Usa una App Password si tienes 2FA
    },
    tls: {
